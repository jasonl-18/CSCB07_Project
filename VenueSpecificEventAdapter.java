...
public class VenueSpecificEventAdapter extends RecyclerView.Adapter<VenueSpecificEventAdapter.VJEViewHolder> {
    Context context;
    String username;
    ArrayList<eventModel> eventList = new ArrayList<>();

    public VenueSpecificEventAdapter(Context context, ArrayList<eventModel> eventList, String username) {
    ...
    @NonNull
    @Override
    public VenueSpecificEventAdapter.VJEViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Inflate the layout here
        // This is how we give look to our rows
        LayoutInflater inflator = LayoutInflater.from(context);
        View view = inflator.inflate(R.layout.join_event_node, parent, false);
        return new VenueSpecificEventAdapter.VJEViewHolder(view, eventList, username);
    }

    @Override
    public void onBindViewHolder(@NonNull VenueSpecificEventAdapter.VJEViewHolder holder, int position) {
